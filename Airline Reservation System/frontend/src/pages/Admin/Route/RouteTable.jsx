...
const RouteTable = () => {
    ...
    const handleDelete = async(id) => {
        try {
            await axios.delete(`http://localhost:8000/route/`+id)
    ...
    const rows : GridRowsProp = routes.map(route => ({id: route.route_id, origin: route.origin, destination: route.destination,
        e_price : route.economy_price , b_price : route.business_price , p_price : route.platinum_price }));
                ...
                return (
                  <Stack direction="row" spacing={2}>
                    ...
                    <DialogTitle id="responsive-dialog-title">
                        ...
                        <DialogContent>
                        <DialogContentText>
                            Are you sure you want to delete route instance? You might not be able to store it again.
                        </DialogContentText>
                        </DialogContent>
                        <DialogActions>
