...
const FlightResultsTable = () => {
  ...
  const rows: GridRowsProp = Results.map((Result) => ({
    id: Result.flight_id,
    aircraftName: Result.call_sign,
    originAirport,
    targetAirport,
    departureTime: removeTAndZ(Result.departure_time),
    arrivalTime: removeTAndZ(Result.arrival_time),
  ...
  return (
    <>
      ...
      <Background />
      <br></br>
      <div className="glassBoxflightresult">
